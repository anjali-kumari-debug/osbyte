...
string ssdp_build_search_response(void) {
    ...
    extra[2] = (HTTPHeader){ string_from_literal("SERVER"), string_from_literal("OsbyteOS/1.0 UPnP/1.1")};
    extra[3] = (HTTPHeader){ string_from_literal("ST"), string_from_literal("ssdp:all")};
    extra[4] = (HTTPHeader){ string_from_literal("USN"), string_from_literal("uuid:osbyte-os::upnp:rootdevice")};
...
string ssdp_build_notify(bool alive, bool v6) {
    ...
    extra[3] = (HTTPHeader){ string_from_literal("USN"), string_from_literal("uuid:osbyte-os::upnp:rootdevice")};
    extra[4] = (HTTPHeader){ string_from_literal("CACHE-CONTROL"), string_from_literal("max-age=1800")};
    extra[5] = (HTTPHeader){ string_from_literal("SERVER"), string_from_literal("OsbyteOS/1.0 UPnP/1.1")};
